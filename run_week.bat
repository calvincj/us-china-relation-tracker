...
REM
REM Usage:
REM   run_week.bat                                    (last complete week)
REM   run_week.bat --start 2026-08-04 --end 2026-08-10 (a specific week instead)
REM   run_week.bat -v                                  (show full detail, not just progress)
REM
REM What happens:
